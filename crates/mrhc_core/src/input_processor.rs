...
mod tests {
    ...
    async fn test_read_request() {
        let data: &[u8] = &[
            0x08, 0x57, 0x4A, 0x4A, 0x0A, 0x13, 0x68, 0x74, 0x74, 0x70, 0x3A, 0x2F, 0x2F, 0x74,
    ...
    async fn test_input_processor_run() {
        ...
        let data: &'static [u8] = &[
            ...
            // Request
            0x08, 0x57, 0x4A, 0x4A, 0x0A, 0x13, 0x68, 0x74, 0x74, 0x70, 0x3A, 0x2F, 0x2F, 0x74, 0x65, 0x73, 
            0x74, 0x2E, 0x62, 0x61, 0x63, 0x6B, 0x65, 0x6E, 0x64, 0x12, 0x11, 0x2F, 0x74, 0x6D, 0x70, 0x2F, 
            0x63, 0x6C, 0x69, 0x65, 0x6E, 0x74, 0x5F, 0x64, 0x61, 0x74, 0x61, 0x2F, 0x1A, 0x0F, 0x73, 0x6F, 
            0x6D, 0x65, 0x2D, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2D, 0x31, 0x32, 0x33, 0x22, 0x0F, 0x73, 
            0x6F, 0x6D, 0x65, 0x2D, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2D, 0x31, 0x32, 0x33, 
        ];
