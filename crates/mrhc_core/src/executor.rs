    ...
    async fn process_request(&mut self, tag: u64, content: RequestContent) {
        ...
        match content {
            ...
            RequestContent::LoginSsoRequest(request) => {
                ...
                self.send_response(tag, result.map(ResponseContent::LoginSsoResponse));
            }
            ...
            RequestContent::UserRequest(request) => {
                ...
                self.send_response(tag, result.map(ResponseContent::UserResponse));
            }
            ...
            RequestContent::MessageSendRequest(request) => {
                ...
                self.send_response(tag, result.map(ResponseContent::MessageSendResponse));
            }
...
mod tests {
    ...
    async fn test_user_request() {
        ...
        let client = ClientMock {
            get_user_response: Ok(response.clone()),
            ..Default::default()
        };
    ...
    async fn test_user_request_err() {
        ...
        let client = ClientMock {
            get_user_response: Err(response.clone()),
            ..Default::default()
        };
    ...
    async fn test_public_room_list_request() {
        ...
        let client = ClientMock {
            get_public_rooms_response: Ok(response.clone()),
            ..Default::default()
        };
    ...
    async fn test_public_room_list_request_err() {
        ...
        let client = ClientMock {
            get_public_rooms_response: Err(response.clone()),
            ..Default::default()
        };
    ...
    async fn test_remove_reaction_request_err() {
        ...
        let client = ClientMock {
            remove_reaction_response: Err(response.clone()),
            ..Default::default()
        };
